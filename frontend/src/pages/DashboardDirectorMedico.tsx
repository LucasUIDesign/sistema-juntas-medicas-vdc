...
const sidebarLinks = [
  {
    ...
    href: '/dashboard/director-medico/nueva-junta',
  ...
  {
    name: 'Baremos',
    href: '/dashboard/director-medico/baremos',
    icon: <BookOpenIcon className="h-5 w-5" />,
  },
  {
    name: 'Perfil',
    href: '/dashboard/director-medico/perfil',
    icon: <UserCircleIcon className="h-5 w-5" />,
  },
];

const DashboardDirectorMedico = () => {
  const { user } = useAuth();
        ...
        <div className="p-4 lg:p-8">
          ...
          <div className="mb-6">
            ...
            <p className="text-vdc-secondary text-sm mt-1">
              Director Médico - Acceso completo a funcionalidades
            </p>
          </div>
...
export default DashboardDirectorMedico;
