...
const sidebarLinks = [
  {
    ...
    href: '/dashboard/administrativo/juntas',
    icon: <ClipboardDocumentListIcon className="h-5 w-5" />,
  },
  {
    name: 'Pacientes',
    href: '/dashboard/administrativo/pacientes',
    icon: <UserGroupIcon className="h-5 w-5" />,
  },
  {
    name: 'Mi Perfil',
    href: '/dashboard/administrativo/perfil',
        ...
        <div className="p-4 lg:p-8">
          ...
          <div className="mb-6">
            ...
            <p className="text-vdc-secondary text-sm mt-1">
              Administrativo - Gestión de datos del sistema
            </p>
          </div>
